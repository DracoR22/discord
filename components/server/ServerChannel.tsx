...
const ServerChannel = ({channel, server, role}: ServerChannelProps) => {
  ...
  // --------------Prevent parent button onClick function overwrites children onClicks functions---------- //
  ...
  return (
    <button onClick={onClick} className={cn(`group px-2 py-2 rounded-md flex items-center gap-x-2 w-full

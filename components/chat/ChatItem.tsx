...
const ChatItem = ({ id, content, member, timestamp, fileUrl, deleted, currentMember, isUpdated, socketUrl, socketQuery }:ChaItemProps) => {
 ...
 //PRESS ESCAPE KEY TO EXIT EDIT FUNCTIONALITY
 useEffect(() => {
                    ...
                    <FormItem className='flex-1'>
                      <FormControl>
                        <div className='relative w-full'>
                          ...
                          placeholder='Edited message' {...field} disabled={isLoading}/>
                        </div>
                      </FormControl>
                    </FormItem>
                  )}/>
                  <Button size='sm' variant='primary' isLoading={isLoading}>
                    Save
                  </Button>
                </form>
